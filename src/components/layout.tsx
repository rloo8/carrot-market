...
export default function Layout({
  ...
  return (
    <div>
      <div className="fixed top-0 flex justify-center items-center w-full max-w-xl bg-white text-lg font-medium text-gray-700 border-b py-4">
        {canGoBack ? (
          <div className="absolute left-4 cursor-pointer" onClick={onClick}>
            <svg
