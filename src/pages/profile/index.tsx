    ...
    <Layout title="내 프로필" hasTabBar>
      <div className="px-4">
        ...
        <div className="flex justify-around mt-10">
          <ProfileButton href="/profile/sold" text="판매내역">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <ProfileButton href="/profile/bought" text="구매내역">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <ProfileButton href="/profile/loved" text="관심목록">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
